...
struct CacheStat {
  ...
  uint64_t numWritebacksIncl{0};
  uint64_t numWritebacksExcl{0};
  uint64_t numWritebackBytes{0};
...
struct PoolStats {
  ...
  uint64_t numWritebacksIncl() const noexcept;
  uint64_t numWritebacksExcl() const noexcept;
  // number of writebacks for this pool
  uint64_t numWritebackBytes() const noexcept;
  // number of writebacks for this pool
