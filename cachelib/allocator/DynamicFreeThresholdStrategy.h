...
class DynamicFreeThresholdStrategy : public BackgroundMoverStrategy {
 public:
  DynamicFreeThresholdStrategy(double lowEvictionAcWatermark,
...
#pragma clang diagnostic ignored "-Wunused-private-field"
  ...
  std::map<MemoryDescriptorType,double> acMaxEvictionBatch;
  std::map<MemoryDescriptorType,double> pAllocLatency;
  std::map<MemoryDescriptorType,int> direction;
#if defined(__clang__)
