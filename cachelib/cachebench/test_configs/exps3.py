...
with open(exp_res_file_lat, 'w') as f:
    line = "workload,size,ratio,bg-int,bg-size,mem,op,percentile,value\n"
    f.write(line)
with open(exp_res_file_tp, 'w') as f:
    line = "workload,size,ratio,bg-int,bg-size,mem,variable,value\n"
    f.write(line)
                ...
                for bi in backgroundEvictorInterval:
                    for keepfree in backgroundEvictorKeepFree:
                        for m in memconfig:
                            ...
                            conf_p = "_wrkld_" + str(l) + "_size_" + str(s) + "_ratio_" + str(r) + "_reduced-cs_" + "_mem_" + m + "_bgi_" + str(bi) + "_keepfree_" + str(keepfree)
                            ...
                            tp = tp.split('\n')
                            res_p = str(l) + "," + str(s) + "," + str(r) + "," + str(bi) + "," + str(keepfree) + "," + m 
